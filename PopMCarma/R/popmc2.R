...
#	names(df_)<-c(names(df_),newname)
	y <- .Call("popmc2",df_=df_,ymis_index_=which(is.na(df_$smokes_hav)),parlist_=par_,theta_dens_=theta_dens_,theta_prop_=theta_prop_,d_k_log=d_k_log_,d_g_log=d_g_log_,PACKAGE="PopMC")
